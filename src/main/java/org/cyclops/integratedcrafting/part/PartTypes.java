...
public class PartTypes {
    ...
    public static final PartTypeInterfaceCraftingEnumerated INTERFACE_CRAFTING_ENUMERATED = REGISTRY.register(new PartTypeInterfaceCraftingEnumerated("interface_crafting_enumerated"));
