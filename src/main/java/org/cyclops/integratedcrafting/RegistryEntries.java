...
public class RegistryEntries {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<ContainerPartInterfaceCraftingAttunedRecipes>> CONTAINER_INTERFACE_CRAFTING_ATTUNED_RECIPES = DeferredHolder.create(Registries.MENU, Identifier.parse("integratedcrafting:part_interface_crafting_attuned_recipes"));
    public static final DeferredHolder<MenuType<?>, MenuType<ContainerPartInterfaceCraftingAttunedOffsets>> CONTAINER_INTERFACE_CRAFTING_ATTUNED_OFFSETS = DeferredHolder.create(Registries.MENU, Identifier.parse("integratedcrafting:part_interface_crafting_attuned_offsets"));
