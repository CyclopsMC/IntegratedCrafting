...
public class RegistryEntries {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<ContainerPartInterfaceCraftingAttunedOffsets>> CONTAINER_INTERFACE_CRAFTING_ATTUNED_OFFSETS = DeferredHolder.create(Registries.MENU, ResourceLocation.parse("integratedcrafting:part_interface_crafting_attuned_offsets"));
