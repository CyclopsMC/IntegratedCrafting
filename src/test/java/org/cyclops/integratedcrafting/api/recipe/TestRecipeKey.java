...
public class TestRecipeKey {
    ...
    protected static IRecipeDefinition newRecipe(long input, long output, ResourceKey<Recipe<?>> recipeId) {
    ...
    protected static ResourceKey<Recipe<?>> recipeKey(String recipeId) {
        return ResourceKey.create(Registries.RECIPE, Identifier.parse(recipeId));
    }
    ...
    public void testRecipeIdKeyRoundTrip() {
        RecipeKey key = RecipeKey.of(null, newRecipe(1, 2, recipeKey("minecraft:chest")));
    ...
    public void testRecipeIdKeysAreCompared() {
        ...
        assertThat(RecipeKey.of(null, newRecipe(3, 4, recipeKey("minecraft:chest"))), is(key));

        assertThat(RecipeKey.of(null, newRecipe(1, 2, recipeKey("minecraft:trapped_chest"))), is(not(key)));
    }
